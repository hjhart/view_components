...
module Primer
  ...
  class PopoverComponent < Primer::Component
    ...
    renders_one :body, lambda { |caret: CARET_DEFAULT, large: false, **system_arguments|
      ...
      # TODO: Ideally we should use the Primer CSS Popover-body-caret-margin classes, but that will be a non trivial breaking change given usages of this component calculate the position in different ways.
      @body_arguments[:mt] ||= 2
